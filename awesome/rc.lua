...
config_dir = ("/home/pan/.config/awesome/")
...
-- TODO: using arrows
arr1 = wibox.widget.textbox()
arr1:set_markup('<span color="#313131" background="#777E76"></span>')
arr2 = wibox.widget.textbox()
arr2:set_markup('<span color="#777E76" background="#C2C2A4"></span>')
arr3 = wibox.widget.textbox()
arr3:set_markup('<span color="#C2C2A4" background="#92B0A0"></span>')
arr4 = wibox.widget.textbox()
arr4:set_markup('<span color="#92B0A0" background="#D0785D"></span>')
arr5 = wibox.widget.textbox()
arr5:set_markup('<span color="#D0785D" background="#4B3B51"></span>')
arr6 = wibox.widget.textbox()
arr6:set_markup('<span color="#4B3B51" background="#4B696D"></span>')
arr7 = wibox.widget.textbox()
arr7:set_markup('<span color="#4B696D" background="#777E76"></span>')
arr8 = wibox.widget.textbox()
arr8:set_markup('<span color="#777E76" background="#313131"></span>')
arr9 = wibox.widget.textbox()
arr9:set_markup('<span color="#313131" background="#222222"></span>')
...
local strf = '<span font="' .. font .. '" color="#EEEEEE" background="#777E76"><span font="FontAwesome">\u{f017}</span>%b %d %I:%M</span>'
vicious.register(tdwidget, vicious.widgets.date, strf, 24)
...
vicious.register(netwidget, vicious.widgets.net, function(widget, args)
    ...
    return '<span background="#C2C2A4" font="Office Code Pro 11"> <span font ="Office Code Pro 11" color="#FFFFFF">'..args["{"..interface.." down_kb}"]..'kbps'..'</span></span>' end, 10)
...
vicious.register( batwidget, vicious.widgets.bat, '<span background="#92B0A0" font="Office Code Pro 11"><span font="Office Code Pro 11" color="#FFFFFF" background="#92B0A0">$1$2% </span></span>', 30, "BAT0" )
...
'<span background="#D0785D" font="Office Code Pro 11"> <span font="Office Code Pro 11" color="#EEEEEE">${/home used_gb}/${/home avail_gb} GB </span></span>', 
800)
...
'<span background="#4B3B51" font="Office Code Pro 11"><span font="Office Code Pro 11" color="#EEEEEE"> Vol:$1 </span></span>', 0.3, "Master")
...
'<span background="#4B696D" font="Office Code Pro 11"> <span font="Office Code Pro 11" color="#DDDDDD">$2%<span color="#888888">·</span>$3% </span></span>', 5)
...
vicious.register(memwidget, vicious.widgets.mem, '<span background="#777E76" font="Office Code Pro 11"> <span font="Office Code Pro 11" color="#EEEEEE" background="#777E76">$2MB </span></span>', 20)
...
-- {{ Vim-like controls:
    ...
    awful.key({ modkey, "Shift"   }, "q", function ()
        ...
        awful.prompt.run({prompt = "Quit (type 'y' to confirm)? "},
